<?php
	...
	function sociallocker_register_help($pages)
	{
			...
			array(
				...
				'items' => array(
					array(
						...
						'title' => __('What is it?', 'bizpanda')
					),
					array(
						'name' => 'usage-example-social-locker',
						'title' => __('Quick Start Guide', 'bizpanda')
					)

					/**
					 * array(
					 * 'name' => 'other-notes-social-locker',
					 * 'title' => __('Other Notes', 'bizpanda')
					 * )
					 */
				)
			),
		...
		if( onp_lang('ru_RU') ) {
			$items[] = array(
				'name' => 'sociallocker-last-updates',
		...
		array_unshift($pages, array(
			'name' => 'sociallocker',
			'title' => __('Plugin: Social Locker', 'bizpanda'),
			'items' => $items
		));
	...
	function sociallocker_change_menu_title($title)
	{
		...
		return __('Social Locker', 'bizpanda');
	}
